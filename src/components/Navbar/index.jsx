...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    return () => {
      socket.off("newNotification", handleNewNotification); // Clean up the event listener
      socket.disconnect();
      console.log("disconnected from socket server");
    };
  }, [user]);
  ...
  return (
    <>
      ...
      {showNotifications && (
        <div className="fixed top-14 right-5 z-50 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
