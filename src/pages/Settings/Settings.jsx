...
//   return (
//     <div className=" mx-auto p-6  md:w-[60%] bg-white shadow-lg rounded-lg">
...
//           className="w-full p-3 border border-gray-300 rounded focus:outline-none focus:border-green-900"
//           required
//         />
//         <button
//           type="button"
      ...
      <form onSubmit={handlePasswordChange} className="mb-8">
        ...
        <div className="mb-4 relative">
          ...
          <input
            ...
            value={currentPassword}
            onChange={(e) => setCurrentPassword(e.target.value)}
            className="w-full p-3 border border-gray-300 rounded focus:outline-none focus:border-green-900 pr-10"
            required
          />
          <button
            type="button"
